 ...
 */
function podofcast_testimonial_slider_block_init() {

	register_block_type(
		__DIR__,
		array(
			'render_callback' => 'podofcast_testimonial_slider_render_callback',
		)
	);
}
add_action( 'init', 'podofcast_testimonial_slider_block_init' );
 ...
 */
function podofcast_testimonial_slider_render_callback( $attributes, $content, $block_instance ) {
	ob_start();
	/**
	 ...
	 */
	require __DIR__ . '/testimonial-slider.php';
	return ob_get_clean();
}
